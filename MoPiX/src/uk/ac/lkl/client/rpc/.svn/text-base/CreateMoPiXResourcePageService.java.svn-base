...
public class CreateMoPiXResourcePageService {
    public static MoPiXResourcePageServiceAsync createMoPiXResourcePageService() {
	...
	//
	MoPiXResourcePageServiceAsync resourcePageServiceService = 
	    (MoPiXResourcePageServiceAsync) GWT.create(MoPiXResourcePageService.class);
